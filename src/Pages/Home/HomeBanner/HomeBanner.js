            ...
            <div id='home' className='container mx-auto py-32 px-8'>
                ...
                <div class="grid lg:grid-cols-2 gap-4">
                    ...
                    <div
                        ...
                        <h2 className='text-[#e46161] text-2xl md:text-3xl lg:text-6xl font-semibold'>MASTODON</h2>
                        <h3 className='text-[#f1b963] text-xl md:text-3xl mb-8 font-semibold'>The | Automation | Automobile</h3>
                        ...
                        <div className='flex flex-col '>
                            ...
                            <button data-aos="fade-right"
                                data-aos-easing="linear"
                                data-aos-duration="1500" className="text-white bg-[#1cbf1f90]  hover:bg-[#94ca21cf] font-bold rounded-full md:text-lg px-5 py-5  mr-2 mb-2 my-2 w-3/4 md:w-1/3 hover:shadow-lg">Garages</button>
                            <button data-aos="fade-right"
                                data-aos-easing="linear"
