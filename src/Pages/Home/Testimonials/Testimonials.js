...
const Testimonials = () => {
    return (
        ...
        <div id='testimonials' className='container mx-auto py-32 px-8'>
            <h2 className='text-[#e46161] text-center text-2xl sm:text-4xl lg:text-6xl font-bold py-8'>Testimonials</h2>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center gap-4 '>
                ...
                <div className=" p-4 m-4 shadow-lg shadow-gray-300/80 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300">
                    <div className='flex justify-center items-center'>
                        ...
                        <h2 className='text-[#f1b963] font-bold'>Helal Uddin</h2>
                    </div>
                    <div className="rating">
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-[#a1e826]" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-[#a1e826]" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-[#a1e826]" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-[#a1e826]" checked />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-[#a1e826]" />
                    </div>
                ...
                <div className="p-4 m-4 shadow-lg shadow-gray-300/80 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300">
                    <div className='flex justify-center items-center'>
                        ...
                        <h2 className='text-[#f1b963] font-bold'>Isha Khan</h2>
                    </div>
                    <div className="rating">
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-[#a1e826]" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-[#a1e826]" />
                ...
                <div className="p-4 m-4 shadow-lg shadow-gray-300/80 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300">
                    <div className='flex justify-center items-center'>
                        ...
                        <h2 className='text-[#f1b963] font-bold'>Jannatul Ferdous</h2>
                    </div>
                    <div className="rating">
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-[#a1e826]" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-[#a1e826]" />
